...
public class TabbedScrollPaneTest2 {
	Dimension theDimension;
	/**
	 * @param args
	 */
	JFrame theFrame;
	public TabbedScrollPaneTest2(){
		...
		theFrame.add(yy,BorderLayout.EAST);
		theFrame.add(new Button("DD"),BorderLayout.WEST);
	...
	public static void main(String[] args) {
		TabbedScrollPaneTest2 g = new TabbedScrollPaneTest2();
	}
